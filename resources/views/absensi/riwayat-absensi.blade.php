        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div class="btn-group">
                    ...
                    <a href="{{ route('karyawan.riwayat-absensi', ['type' => 'kelas', 'period' => $period]) }}" class="btn btn-sm {{ $type == 'kelas' ? 'btn-primary' : 'btn-outline-primary' }}">Absensi {{ Auth::user()->karyawan->jabatan == 'Guru' ? 'Mengajar' : 'Siswa' }}</a>
                </div>
            </div>
            <div class="card-body">
                <div class="row mb-4">
