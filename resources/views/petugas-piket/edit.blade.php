@extends('templates')
@section('header', 'Edit Jadwal Petugas Piket')
        ...
        <div class="card-body">
            <form action="{{ route('petugas-piket.update', $petugasPiket) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select name="karyawan_id" id="karyawan_id" class="form-select" required>
                        ...
                        @foreach ($karyawanList as $karyawan)
                            <option value="{{ $karyawan->id }}" {{ old('karyawan_id', $petugasPiket->karyawan_id) == $karyawan->id ? 'selected' : '' }}>
                ...
                <div class="mb-3">
                    ...
                    <input type="date" name="tanggal" id="tanggal" class="form-control" value="{{ old('tanggal', $petugasPiket->tanggal) }}" required>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="keterangan" id="keterangan" class="form-control" rows="3">{{ old('keterangan', $petugasPiket->keterangan) }}</textarea>
