            ...
            <ul class="menu">
                @php
                    ...
                    $isWaliKelas =
                        $role === 'karyawan' &&
                        Auth::user()->karyawan &&
                        strtolower(Auth::user()->karyawan->jabatan) === 'walikelas' &&
                ...
                @if ($role === 'karyawan')
                    ...
                    <!-- Laporan section for Wali Kelas -->
                    @if ($isWaliKelas)
                        <li class="sidebar-title">Laporan Wali Kelas</li>

                        <li
                            class="sidebar-item {{ request()->is('karyawan/laporan-absensi-siswa*') ? 'active' : '' }}">
                            <a href="{{ route('karyawan.laporan-absensi-siswa') }}" class='sidebar-link'>
                                <i class="bi bi-file-text"></i>
                                <span>Laporan Absensi Kelas</span>
                            </a>
                        ...
                        <li
                            class="sidebar-item {{ request()->is('karyawan/laporan-absensi-gerbang*') ? 'active' : '' }}">
                            <a href="{{ route('karyawan.laporan-absensi-gerbang') }}" class='sidebar-link'>
                                <i class="bi bi-door-open"></i>
                                <span>Laporan Absensi Gerbang</span>
                            </a>
                        ...
                        <li
                            class="sidebar-item {{ request()->is('karyawan/laporan-absensi-guru-kelas*') ? 'active' : '' }}">
                            <a href="{{ route('karyawan.laporan-absensi-guru-kelas') }}" class='sidebar-link'>
                    ...
                    <!-- Laporan section for Kurikulum -->
                    @if ($isKurikulum)
                        <li class="sidebar-title">Laporan Kurikulum</li>
