                            ...
                            <div class="card-body">
                                <form action="{{ route('karyawan.laporan-absensi-gerbang') }}" method="GET" class="row g-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select name="role" id="role" class="form-select" onchange="toggleKelasFilter()">
                                            <option value="">Semua</option>
                                            <option value="siswa" {{ isset($role) && $role == 'siswa' ? 'selected' : '' }}>Siswa</option>
                                            <option value="karyawan" {{ isset($role) && $role == 'karyawan' ? 'selected' : '' }}>Karyawan</option>
                                        </select>
                                    </div>
                                    @endif
                                    ...
                                    @if(isset($kelasList) && strtolower(Auth::user()->karyawan->jabatan) === 'kurikulum')
                                        <div class="col-md-3" id="kelas-filter" style="{{ isset($role) && $role == 'karyawan' ? 'display: none;' : '' }}">
                        ...
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                <div class="d-grid gap-2">
                                    <a href="{{ route('karyawan.riwayat-absensi.export-pdf', ['type' => $type, 'period' => $period, 'start_date' => $customStart, 'end_date' => $customEnd, 'role' => $role ?? '', 'kelas_id' => $kelas->id ?? '']) }}" class="btn btn-danger">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-4">
                        <div class="card bg-info text-white">
                            <div class="card-body">
                                <h5 class="card-title text-white">Total {{ isset($role) && $role == 'karyawan' ? 'Karyawan' : 'Siswa' }}</h5>
                            ...
                            @if($absensi->count() > 0)
                                ...
                                @foreach($absensi as $item)
                                    <tr>
                                        ...
                                        <td>
                                            @if(isset($item->siswa) && isset($item->siswa->kelas))
