            ...
            <div class="card-body px-3 py-4-5">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p class="mb-0">Anda login sebagai <span class="badge bg-primary">{{ ucfirst(Auth::user()->role) }}</span> dengan jabatan <span class="badge bg-info">{{ Auth::user()->karyawan->jabatan }}</span></p>
                    </div>
                </div>
            </div>
        </div>
...
@php
    ...
    $isWaliKelas = strcasecmp(Auth::user()->karyawan->jabatan, 'wali kelas') === 0 && !empty(Auth::user()->karyawan->kelas_id);
            ...
            <div class="card-body">
                <div class="d-flex align-items-center mb-4">
                    ...
                    @else
                        ...
                        <div>
                            <h5 class="mb-0">Belum Absensi Gerbang</h5>
                            <a href="{{ route('karyawan.download-qrcode', $karyawan->id) }}" class="btn btn-sm btn-primary mt-2">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4 col-6 mb-3">
                        <a href="{{ route(Auth::user()->role .'.absensi-gerbang.scan') }}" class="btn btn-primary btn-block w-100">
                    ...
                    <div class="col-md-4 col-6 mb-3">
                        <a href="{{ route(Auth::user()->role .'.absensi-siswa-kelas.index') }}" class="btn btn-info btn-block w-100">
                    ...
                    <div class="col-md-4 col-6 mb-3">
                        <a href="{{ route(Auth::user()->role .'.riwayat-absensi') }}" class="btn btn-success btn-block w-100">
                    ...
                    @if($isGuru)
                    <div class="col-md-4 col-6 mb-3">
                        <a href="{{ route(Auth::user()->role .'.jadwal-pelajaran.index') }}" class="btn btn-secondary btn-block w-100">
                    ...
                    @if($isWaliKelas)
                    <div class="col-md-4 col-6 mb-3">
                        <a href="{{ route(Auth::user()->role .'.laporan-absensi-siswa') }}" class="btn btn-secondary btn-block w-100">
                    ...
                    <div class="col-md-4 col-6 mb-3">
                        <a href="#" class="btn btn-danger btn-block w-100" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                    ...
                    <table class="table table-hover table-lg">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if(!$absensiGuru && $absensiGerbangHariIni)
                                        <a href="{{ route(Auth::user()->role .'.absensi-siswa-kelas.kelas', $jadwal->id) }}" class="btn btn-sm btn-primary">
                                            <i class="bi bi-clipboard-check me-1"></i> Absensi Siswa
                                        </a>
                                    @elseif(!$absensiGerbangHariIni)
                                        <button class="btn btn-sm btn-warning" disabled>
                                            <i class="bi bi-exclamation-triangle me-1"></i> Absen Gerbang Dulu
                                        </button>
                                    @else
                                        <a href="{{ route(Auth::user()->role .'.absensi-siswa-kelas.kelas', $jadwal->id) }}" class="btn btn-sm btn-success">
